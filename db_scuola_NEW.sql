...
--
-- Host: 127.0.0.1
-- Creato il: Mag 22, 2019 alle 10:21
...
(9, 3, '1°A', '2018', '2019-05-22 07:56:48', 'Assente'),
(10, 10, '1°A', '2018', '2019-05-22 07:56:48', 'Assente'),
(11, 16, '1°A', '2018', '2019-05-22 07:56:48', 'Assente');
...
--
-- Struttura della tabella `utentecomunicazione`
--

CREATE TABLE `utentecomunicazione` (
  `Utente` varchar(32) NOT NULL,
  `IdComunicazione` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indici per le tabelle `utentecomunicazione`
--
ALTER TABLE `utentecomunicazione`
  ADD KEY `Utente` (`Utente`),
...
--
ALTER TABLE `assenze`
  MODIFY `IdAssenza` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT per la tabella `comunicazioni`
--
ALTER TABLE `comunicazioni`
  MODIFY `IdComunicazione` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Limiti per la tabella `utentecomunicazione`
--
ALTER TABLE `utentecomunicazione`
  ADD CONSTRAINT `utentecomunicazione_ibfk_1` FOREIGN KEY (`Utente`) REFERENCES `utenti` (`Utente`),
  ADD CONSTRAINT `utentecomunicazione_ibfk_2` FOREIGN KEY (`IdComunicazione`) REFERENCES `comunicazioni` (`IdComunicazione`);
